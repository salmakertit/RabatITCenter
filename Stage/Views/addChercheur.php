        ...
        <div class="row">
          <div class="wrapper">
            ...
            <article class="part card-details">
              <form method='post' action='index.php?action=addChercheurFonc' >
                ...
                <div class='group card-name'>
                    ...
                    <select name = "idstructure">
                      <?php
                        $size = count($array['IDSTRUCTURE']);
                        for($i = 0; $i < $size; $i++){
                    ?>
                          <option value="<?php echo $array['IDSTRUCTURE'][$i]; ?>"><?php echo $array['NOMSTRUCTURE'][$i]; ?></option>
                      <?php
                    }
                    ?>
                    </select>
