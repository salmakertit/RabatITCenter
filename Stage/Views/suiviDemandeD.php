                          ...
                          ?>  
                            <tr>
                              ...
                              <td>
                                ...
                                <a onclick="return confirm('Are you sure?')" href="index.php?action=acceptDemandeD&id=<?php echo $array['IDDEMANDE'][$i];?>" class="btn btn-primary waves-effect waves-light btnmodifier"  title="Modification"><i class="fa fa-edit"></i></a> 
