      ...
      <nav class="main_nav_container">
        <div class="main_nav">
          <ul class="main_nav_list">
            ...
            <li class="main_nav_item"><a href="index.php?action=aboutus">à propos de nous</a></li>
            <li class="main_nav_item"><a href="index.php?action=contact">contact</a></li>
              <?php
                if(isset($_SESSION['ACTIF']) && $_SESSION['ACTIF'] == 'YES'){
                  ...
                  echo "<li class=\"main_nav_item\"><a href=\"index.php?action=connect\">se connecter</a></li>";
                }
              ?>
          </ul>
        </div>
        ...
        <div class="hero_slide">
          ...
          <div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
            <div class="hero_slide_content text-center">
              <h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">Bienvenue sur la plateforme de <span>Rabat IT center</span></h1>
            </div>
          </div>
        </div>
